...
void AFPSExperimentCharacter::BeginPlay()
{
	...
	FP_Gun->AttachToComponent(GetMesh(), FAttachmentTransformRules(EAttachmentRule::SnapToTarget, true), weaponSocketName);
...
void AFPSExperimentCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Aim", IE_Pressed, this, &AFPSExperimentCharacter::OnAim);
	PlayerInputComponent->BindAction("Aim", IE_Released, this, &AFPSExperimentCharacter::OnAimEnd);
...
void AFPSExperimentCharacter::OnAim()
{
	bIsAiming = true;
}

void AFPSExperimentCharacter::OnAimEnd()
{
	bIsAiming = false;
}
